...
// Function to get icon source based on the user's selected icon
function getIconSrc(icon) {
  // Replace with the actual paths to your icon images
  switch (icon) {
    case 'icon1':
      return 'path/to/icon1.png';
    case 'icon2':
      return 'path/to/icon2.png';
    case 'icon3':
      return 'path/to/icon3.png';
    default:
...
document.getElementById('comment').addEventListener('click', function () {
  document.getElementById('comments').classList.toggle('active');
});
